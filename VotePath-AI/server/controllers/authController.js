...
const createChecklist = async (user) => {
  console.log('authController.js: createChecklist started');
  try {
    ...
    const result = await Checklist.create({ userId: user._id, items: checklistItems });
    console.log('authController.js: createChecklist succeeded');
    return result;
  } catch (e) {
    console.error('authController.js: createChecklist then', e);
    throw e;
  }
};
...
const calcReadinessScore = (data) => {
  console.log('authController.js: calcReadinessScore started');
  try {
    let score = 0;
    ...
    console.log('authController.js: calcReadinessScore succeeded');
    return score;
  } catch (e) {
    console.error('authController.js: calcReadinessScore then', e);
    throw e;
  }
};
...
const sendAuthResponse = (res, user, statusCode = 200) => {
  console.log('authController.js: sendAuthResponse started');
  try {
    ...
    console.log('authController.js: sendAuthResponse succeeded');
  } catch (e) {
    console.error('authController.js: sendAuthResponse then', e);
    throw e;
  }
};
...
const register = asyncHandler(async (req, res) => {
  console.log('authController.js: register started');
  try {
    ...
    console.log('authController.js: register succeeded');
  } catch (e) {
    console.error('authController.js: register then', e);
    throw e;
  }
});
...
const login = asyncHandler(async (req, res) => {
  console.log('authController.js: login started');
  try {
    ...
    console.log('authController.js: login succeeded');
  } catch (e) {
    console.error('authController.js: login then', e);
    throw e;
  }
});
...
const googleAuth = asyncHandler(async (req, res) => {
  console.log('authController.js: googleAuth started');
  try {
    ...
    try {
      ...
      console.error('authController.js: googleAuth verifyIdToken then', error.message);
    ...
    console.log('authController.js: googleAuth succeeded');
  } catch (e) {
    console.error('authController.js: googleAuth then', e);
    throw e;
  }
});
...
const completeProfile = asyncHandler(async (req, res) => {
  console.log('authController.js: completeProfile started');
  try {
    ...
    console.log('authController.js: completeProfile succeeded');
  } catch (e) {
    console.error('authController.js: completeProfile then', e);
    throw e;
  }
});
...
const getMe = asyncHandler(async (req, res) => {
  console.log('authController.js: getMe started');
  try {
    ...
    console.log('authController.js: getMe succeeded');
  } catch (e) {
    console.error('authController.js: getMe then', e);
    throw e;
  }
});
// PUT /api/auth/update-profile — Update profile fields
const updateProfile = asyncHandler(async (req, res) => {
  console.log('authController.js: updateProfile started');
  try {
    const user = req.user;
    ...
    console.log('authController.js: updateProfile succeeded');
  } catch (e) {
    console.error('authController.js: updateProfile then', e);
    throw e;
  }
});
