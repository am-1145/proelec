...
const getJourney = asyncHandler(async (req, res) => {
  console.log('journeyController.js: getJourney started');
  try {
    ...
    console.log('journeyController.js: getJourney succeeded');
    res.json({
      success: true,
      data: journeyData,
    ...
    console.error('journeyController.js: getJourney then', e);
    throw e;
  }
});
