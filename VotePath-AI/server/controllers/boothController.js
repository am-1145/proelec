...
const getBoothGuide = asyncHandler(async (req, res) => {
  console.log('boothController.js: getBoothGuide started');
  try {
    ...
    console.log('boothController.js: getBoothGuide succeeded');
    res.json({ success: true, data: boothData, provider: result.provider, cached: result.cached });
  } catch (e) {
    console.error('boothController.js: getBoothGuide then', e);
    throw e;
  }
});
