...
const runScenario = asyncHandler(async (req, res) => {
  console.log('scenarioController.js: runScenario started');
  try {
    ...
    console.log('scenarioController.js: runScenario succeeded');
    res.json({ success: true, data: scenarioData, provider: result.provider, cached: result.cached });
  } catch (e) {
    console.error('scenarioController.js: runScenario then', e);
    throw e;
  }
});
...
const getScenarios = asyncHandler(async (req, res) => {
  console.log('scenarioController.js: getScenarios started');
  try {
    console.log('scenarioController.js: getScenarios succeeded');
    res.json({
      success: true,
      data: [
    ...
    console.error('scenarioController.js: getScenarios then', e);
    throw e;
  }
});
